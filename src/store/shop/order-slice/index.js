...
export const createNewOrderByStripe = createAsyncThunk(
...
export const capturePaymentStripe = createAsyncThunk(
...
const shoppingOrderSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createNewOrderByStripe.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(createNewOrderByStripe.fulfilled, (state, action) => {
        state.isLoading = false;
        state.approvalURL = action.payload.approvalURL;
        state.orderId = action.payload.orderId;
        sessionStorage.setItem(
      ...
      .addCase(createNewOrderByStripe.rejected, (state) => {
        state.isLoading = false;
        state.approvalURL = null;
        state.orderId = null;
      })
